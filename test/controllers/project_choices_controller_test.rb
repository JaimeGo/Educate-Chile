...
class ProjectChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_choice" do
    assert_difference('ProjectChoice.count') do
      post project_choices_url, params: { project_choice: { desicion: @project_choice.desicion, p1: @project_choice.p1, p2: @project_choice.p2, p3: @project_choice.p3 } }
    end
  ...
  test "should update project_choice" do
    patch project_choice_url(@project_choice), params: { project_choice: { desicion: @project_choice.desicion, p1: @project_choice.p1, p2: @project_choice.p2, p3: @project_choice.p3 } }
