...
class ProjectChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_choice" do
    assert_difference('ProjectChoice.count') do
      post project_choices_url, params: { project_choice: { desicion: @project_choice.desicion, porqueA: @project_choice.porqueA, porqueB: @project_choice.porqueB, porqueC: @project_choice.porqueC } }
    end
  ...
  test "should update project_choice" do
    patch project_choice_url(@project_choice), params: { project_choice: { desicion: @project_choice.desicion, porqueA: @project_choice.porqueA, porqueB: @project_choice.porqueB, porqueC: @project_choice.porqueC } }
