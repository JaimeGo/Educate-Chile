...
class ProjectConnectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_connection" do
    assert_difference('ProjectConnection.count') do
      post project_connections_url, params: { project_connection: { answers: @project_connection.answers, questions: @project_connection.questions } }
    end
  ...
  test "should update project_connection" do
    patch project_connection_url(@project_connection), params: { project_connection: { answers: @project_connection.answers, questions: @project_connection.questions } }
