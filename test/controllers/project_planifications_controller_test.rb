...
class ProjectPlanificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_planification" do
    assert_difference('ProjectPlanification.count') do
      post project_planifications_url, params: { project_planification: { finishdate: @project_planification.finishdate, name: @project_planification.name, place: @project_planification.place, references: @project_planification.references, startdate: @project_planification.startdate } }
    end
  ...
  test "should update project_planification" do
    patch project_planification_url(@project_planification), params: { project_planification: { finishdate: @project_planification.finishdate, name: @project_planification.name, place: @project_planification.place, references: @project_planification.references, startdate: @project_planification.startdate } }
